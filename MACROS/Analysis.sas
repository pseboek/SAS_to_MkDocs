/**
@macro quali1
@brief Generates a table of two qualitative variables with descriptive measures such as n and %.
...
@return Output table with descriptive measures
...
/**
@macro quanti1
@brief Generates a table of a quantitative variable with descriptive figures such as mean, median, std.
